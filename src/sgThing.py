...
try:
    ...
    for sgName in sgNameListByCPC:
        try:
            ...
            # Identify if SG is fcp or not, we will deal with FCP storage in 1st phase.
            #if sgStorType == 'fcp':
            ...
            if sgStorType == 'fcp':
                # the fcp storage group dedicated properties
            ...
            for sgStorVolDict in sgStorVolURIList:
                ...
                bakStorVolCfg = {#'storVolName':None, #storage volume name
                ...
                if sgStorType == 'fc':
                    ...
                    # device-number or default-device-number???
